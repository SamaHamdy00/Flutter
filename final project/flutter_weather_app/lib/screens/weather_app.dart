...
import 'package:flutter_weather_app/data/get_weather_icon.dart';
import 'package:flutter_weather_app/widgets/my_column.dart';
        ...
        child: BlocBuilder<WeatherBloc, WeatherState>(
          builder: (context, state) {
            if (state is WeatherSuccess) {
                ...
                child: Stack(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        // MySearch(controller: _searchController),
                        Text(
              ...
              //   return MySearch(controller: _searchController);
            } else {
